<template>
  <div class="flex flex-col items-center justify-center p-40">
    <div class="flex flex-col gap-2 p-28 rounded-2xl text-white">
      <p class="text-center text-xl">OLA! ME CHAMO</p>
